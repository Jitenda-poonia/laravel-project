    ...
    <div class="container-fluid p-0 mb-5">
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-indicators">
                ...
                <button type="button" data-bs-target="#header-carousel" data-bs-slide-to="0" class="active" aria-current="true" {{($i)?'active':''}}
            ...
            <div class="carousel-inner">
                @foreach ($sliders as $key => $slider)
                    <div class="carousel-item {{ $i ? 'active' : '' }} " {{ $i = 0 }}>
                        ...
                        <img class="w-100" src="{{ $slider->getFirstMediaUrl('image') }}" alt="Image">
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-7">
                    ...
                    <p class="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum et tempor sit. Aliqu diam amet
                        ...
                        duo justo et tempor eirmod magna dolore erat amet et magna</p>
                    <div class="row g-3">
                    ...
                    <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                        <div class="blog-item">
                            <div class="position-relative">
                                <img class="img-fluid w-100 rounded-top" src="{{ $blog->getFirstMediaUrl('image') }}"
                                    alt="">
                                <div class="blog-date">
                            ...
                            <div class="bg-primary rounded-bottom p-5">
                                ...
                                <a class="h3 m-0 text-white" href="">{!! $blog->description !!}</a>
                            </div>
                        </div>
                    </div>
