...
@push('title')
    <title>blog crete</title>
@endpush
@section('content')
    <div class="row">
        <div class="col-md-12">
            <h1 class="page-head-line">Add Blog</h1>
            <span class="page-subhead-line"><strong><a href="{{route('dashboard')}}">Dashboard</a> >> Add Blog </span>
                ...
                <div class="panel-body">
                    ...
                    <form action="{{route('blog.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="identifier" type="text" value="{{old('identifier')}}">
                            <p class="help-block" style="color:red;">
                                @error('identifier')
                                    {{$message}}
                                @enderror
